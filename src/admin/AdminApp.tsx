...
import { LayoutDashboard, Package, Tag, Megaphone, Settings as SettingsIcon, LogOut, ShieldCheck } from 'lucide-react';
      ...
      <div className="ds ds-admin">
        <aside className="ds-side">
          <div className="ds-side__brand">
            <img src="/talpa-logo.webp" alt="TALPA" /> Admin
          </div>
        ...
        <div className="ds-admin__main">
          <div className="ds-admin__top">
            <div className="ds-admin__acct">
              <ShieldCheck size={16} /> {email}
              <button type="button" className="ds-toggle" onClick={() => void auth.signOut()}>
